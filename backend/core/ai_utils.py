...
def parse_financials_with_groq(raw_text: str, filename: str) -> dict:
    ...
    prompt = f"""Extract financial figures as JSON from {filename}.
Content: {raw_text[:8000]}

Return ONLY valid JSON, nothing else:
{{"companyName":"","revenue":0,"prevRevenue":0,"netProfit":0,"totalAssets":0,
"totalLiabilities":0,"currentAssets":0,"currentLiabilities":0,
"inventory":0,"operatingExpenses":0}}"""
