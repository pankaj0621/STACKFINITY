...
const dashStyles = `
  ...
  .ai-disclaimer-icon { font-size: 14px; flex-shrink: 0; margin-top: 1px; }
  .ai-disclaimer-text { font-family: var(--font-mono); font-size: 10px; color: var(--text2); line-height: 1.7; letter-spacing: 0.02em; }
  .ai-disclaimer-text strong { color: #f59e0b; font-weight: 600; }

  /* Groq insight disclaimer */
  .groq-disclaimer {
  ...
  .groq-disclaimer a { color: var(--cyan); text-decoration: none; }
      ...
      <div className="results-wrap">
        ...
        <div className="ai-disclaimer">
          ...
          <div className="ai-disclaimer-text">
            <strong>AI-Generated Analysis — Not Financial Advice.</strong> Results are produced by Groq LLaMA 3.3 and may contain errors or hallucinated figures.
            Always cross-verify all numbers with your original financial documents before making any business or investment decisions.
            {result.dataSource === "upload" && <> · <strong>PDF extraction accuracy depends on document quality</strong> — incomplete extraction may affect scores.</>}
          </div>
        </div>
        ...
        <div className="bento2">
          <div className="card">
            ...
            <div className="groq-disclaimer">
              ⚠ AI insights are generated by Groq LLaMA and may not reflect actual financial conditions.
              Figures shown are estimates only — verify against audited statements.
